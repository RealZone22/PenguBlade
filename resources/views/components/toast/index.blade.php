@props([
    ...
    'warningIcon' => 'icon-triangle-alert',
    'dangerIcon' => 'icon-x',
])
                ...
                <template x-if="notification.variant === 'info'">
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <!-- Icon -->
                            <div class="rounded-full bg-info/15 p-0.5 px-1.5 text-info" aria-hidden="true">
                                <i class="{{ $infoIcon }} size-5"></i>
                            </div>
                            ...
                            <!--Dismiss Button -->
                            <button type="button" class="ml-auto cursor-pointer" aria-label="dismiss notification"
                                    x-on:click="(isVisible = false), removeNotification(notification.id)">
                                <i class="{{ $closeIcon }} size-5 shrink-0" aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
                </template>
                ...
                <template x-if="notification.variant === 'success'">
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <!-- Icon -->
                            <div class="rounded-full bg-success/15 p-0.5 px-1.5 text-success" aria-hidden="true">
                                <i class="{{ $successIcon }} size-5"></i>
                            </div>
                ...
                <template x-if="notification.variant === 'warning'">
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <!-- Icon -->
                            <div class="rounded-full bg-warning/15 p-0.5 px-1.5 text-warning" aria-hidden="true">
                                <i class="{{ $warningIcon }} size-5"></i>
                            </div>
                ...
                <template x-if="notification.variant === 'danger'">
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <!-- Icon -->
                            <div class="rounded-full bg-danger/15 p-0.5 px-1.5 text-danger" aria-hidden="true">
                                <i class="{{ $dangerIcon }} size-5"></i>
                            </div>
