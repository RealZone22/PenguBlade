...
@elseif($current)
    <li class="flex w-full items-center text-sm" aria-current="step">
        ...
        <div class="flex items-center gap-2 pl-2">
            <span
                {{ $attributes->twMerge('flex size-6 shrink-0 items-center justify-center rounded-full bg-black font-bold text-neutral-100 outline outline-2 outline-offset-2 outline-black dark:bg-white dark:text-black dark:outline-white') }}>
                {{ $number }}
            </span>
...
@else
    <li class="flex w-full items-center text-sm">
        ...
        <div class="flex items-center gap-2 pl-2">
        <span
            {{ $attributes->twMerge('flex size-6 shrink-0 items-center justify-center rounded-full bg-neutral-50 font-medium text-neutral-600 dark:bg-neutral-900 dark:text-neutral-300') }}>
            {{ $number }}
        </span>
